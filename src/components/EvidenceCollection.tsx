    ...
    <div className="p-8 bg-slate-50 min-h-screen">
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-slate-900 mb-2">Evidence Collection</h1>
            <p className="text-slate-600">Automated and manual evidence collection for compliance frameworks</p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="bg-white rounded-xl p-6 border border-slate-200">
          ...
          <p className="text-slate-600 text-sm">Total Evidence Items</p>
        </div>
        ...
        <div className="bg-white rounded-xl p-6 border border-slate-200">
          ...
          <h3 className="text-2xl font-bold text-slate-900 mb-1">{stats.automated}</h3>
          <p className="text-slate-600 text-sm">Automated Collection</p>
        </div>
        ...
        <div className="bg-white rounded-xl p-6 border border-slate-200">
          ...
          <h3 className="text-2xl font-bold text-slate-900 mb-1">{stats.current}</h3>
          <p className="text-slate-600 text-sm">Current Evidence</p>
        </div>
        ...
        <div className="bg-white rounded-xl p-6 border border-slate-200">
          ...
          <h3 className="text-2xl font-bold text-slate-900 mb-1">{stats.warnings}</h3>
      ...
      <div className="space-y-4">
        {filteredEvidence.map((item) => (
          <div key={item.id} className="bg-white rounded-xl p-6 border border-slate-200 hover:shadow-lg transition-all duration-200">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <span className="text-sm text-slate-600">{item.control}</span>
                  </div>
                  <div className="flex items-center space-x-2">
      ...
      {filteredEvidence.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-slate-600">Try adjusting your search criteria or upload new evidence.</p>
        </div>
      )}
    </div>
  );
